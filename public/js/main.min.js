...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content_global_theme_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content_global_theme_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__content_global_theme_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__content_global_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__content_global_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__content_global_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__content_about_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__content_about_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__content_about_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content_volunters_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content_volunters_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__content_volunters_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__content_galery_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__content_galery_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__content_galery_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__content_notices_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__content_notices_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__content_notices_js__);
...
jQuery(function ($) {
	...
	var classModule = document.querySelector('body').className;
...
(function () {
            ...
            if (classModule !== 'homepage' && classModule == 'admin') {
                        ...
                        var listOfLi = document.querySelectorAll('.navbar-nav a');
                        var url = window.location.href.split("/", 3).join("/");
                        var sectionTitle = document.querySelector('.section-title');

                        Array.prototype.forEach.call(listOfLi, function (li) {

                                    var href = li.href.split("#")[1];
                                    li.href = url + '/#' + href;
...
(function () {
				...
				var volunters = document.querySelectorAll('.voluter');
				var modal = document.getElementById('volunterModal');
				var modalTitle = modal.querySelector('#completeNameVolunter');
				var modalImg = modal.querySelector('#pictureVolunter');
				var modalText = modal.querySelector('#textVolunter');

				var showInfo = function showInfo(e) {
								var name = e.currentTarget.text.trim();
								var picture = e.currentTarget.querySelector('img').src;
				...
				Array.prototype.forEach.call(volunters, function (opt) {
...
(function () {
    ...
    var items = document.querySelectorAll('.galery-item');
...
(function () {
    ...
    var items = document.querySelectorAll('.notices-item');
    var modalTitle = document.querySelector('#modalTitle');
    var modalImg = document.querySelector('#modalImg');
