...
(function () {
    ...
    var deleteVideoItems = container.querySelectorAll('.delete-item-video');
    ...
    function saveNotice(e) {
        ...
        request.onload = function () {
            if (request.status >= 200 && request.status < 400) {
                ...
                var message = 'La noticia a sido guardada exitosamente.';

                if (method == 'PUT') {
                    message = 'Los cambios han sido guardados exitosamente.';
                }

                swal('¡Guardado!', message, 'success').then(function () {
    ...
    Array.prototype.forEach.call(deleteVideoItems, function (video) {
        video.addEventListener('click', deleteVideo);
    });
...
(function () {
    ...
    function saveGalery(e) {
        ...
        var token = btn.getAttribute('data-csrf');
        var method = btn.getAttribute('data-method');
        var id = btn.getAttribute('data-galery');
        ...
        request.onload = function () {
            if (request.status >= 200 && request.status < 400) {
                ...
                var message = 'El album ha sido guardado exitosamente.';
