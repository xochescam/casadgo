                    ...
                    <div class="blog-post blog-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms">
                        <article>
                            <div class="entry-header">
                                ...
                                <div class="entry-date">25 Febrero 2017</div>
                                <h2 class="entry-title"><a href="#">Título de noticia</a></h2>
                            </div>
                            ...
                            <div class="entry-content">
                                ...
                                <a class="btn btn-primary" href="{{ route('noticia.show',1) }}">Leer Más</a>
                            </div>
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            ...
                            <div class="media-body">
                                <div class="entry-header">
                                    <div class="entry-date">01 Diciembre 2016</div>
                                    <h2 class="entry-title"><a href="#">Título de noticia</a></h2>
                                </div>

                                <div class="entry-content">
                                    <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi, ea quam. Blanditiis, ex, laboriosam.</P>
                                    <a class="btn btn-primary" href="{{ route('noticia.show',1) }}">Leer Más</a>
                                </div>
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            ...
                            <div class="media-body">
                                <div class="entry-header">
                                    <div class="entry-date">01 Noviembre 2016</div>
                                    <h2 class="entry-title"><a href="#">Título de la noticia</a></h2>
                                </div>
